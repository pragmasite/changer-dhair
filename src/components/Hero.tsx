    ...
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-tight"
        >
          {t.hero.title1}
          <br />
        ...
        <motion.p
          ...
          className="mb-10 max-w-2xl text-lg text-white/85 leading-relaxed"
        >
          {t.hero.description}
        </motion.p>
        ...
        >
          ...
          >
            <a href="mailto:elomiesch@gmail.com">
